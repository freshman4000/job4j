...
public class Controller implements AutoCloseable {
    ...
    private void dbAndTableValidate() {
     ...
     */
    private Connection initConnectionInstance() {
        try {
     ...
     */
    private Connection initConnectionInstance(String database) {
        try {
            Class.forName(properties.getProperty("driver-class-name"));
     ...
     */
    private Properties propLoader(String propFile) {
        Properties properties = new Properties();
        try (InputStream inputStream = Controller.class.getClassLoader().getResourceAsStream(propFile)) {
